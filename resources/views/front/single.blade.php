...
<div class="related_news">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="media">
                <div class="media-left">
                    <a href="#"><img class="media-object" src="{{asset('front/img/cat-mobi-sm1.jpg')}}" alt="Generic placeholder image"></a>
                </div>
            ...
            <div class="media">
                <div class="media-left">
                    <a href="#"><img class="media-object" src="{{asset('front/img/cat-mobi-sm3.jpg')}}" alt="Generic placeholder image"></a>
                </div>
                <div class="media-body">
                    <span class="tag purple"><a href="category.html" target="_self">Mobile</a></span>
        ...
        <div class="col-md-6">
            <div class="media">
                <div class="media-left">
                    <a href="#"><img class="media-object" src="{{asset('front/img/cat-mobi-sm2.jpg')}}" alt="Generic placeholder image"></a>
                </div>
                <div class="media-body">
                    <span class="tag purple"><a href="category.html" target="_self">Mobile</a></span>
            ...
            <div class="media">
                <div class="media-left">
                    <a href="#"><img class="media-object" src="{{asset('front/img/cat-mobi-sm4.jpg')}}" alt="Generic placeholder image"></a>
                </div>
                <div class="media-body">
                    <span class="tag purple"><a href="category.html" target="_self">Mobile</a></span>
...
<div class="readers_comment">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#">
                <img alt="64x64" class="media-object" data-src="{{asset('front/img/reader_img1.jpg')}}" src="{{asset('front/img/reader_img1.jpg')}}" data-holder-rendered="true">
            </a>
        </div>
        <div class="media-body">
            ...
            <div class="media">
                <div class="media-left">
                    <a href="#">
                        <img alt="64x64" class="media-object" data-src="{{asset('front/img/reader_img2.jpg')}}" src="{{asset('front/img/reader_img2.jpg')}}" data-holder-rendered="true">
                    </a>
                </div>
                <div class="media-body">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#">
                <img alt="64x64" class="media-object" data-src="{{asset('front/img/reader_img3.jpg')}}" src="{{asset('front/img/reader_img3.jpg')}}" data-holder-rendered="true">
            </a>
        </div>
        <div class="media-body">
...
<div class="widget m30">
    ...
    <div class="widget_body"><img class="img-responsive left" src="{{asset('front/img/editor.jpg')}}" alt="Generic placeholder image">
...
<div class="widget m30">
    ...
    <div class="widget_body"><img class="img-responsive left" src="{{asset('front/img/reader.jpg')}}" alt="Generic placeholder image">
