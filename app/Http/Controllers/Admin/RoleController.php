...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            ...
            'permission_required' => "You must select Permission",
        ...
        return redirect()->Action([RoleController::class,'index'])->with('success','Role Created Successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->Action([RoleController::class,'index'])->with('success','Role Updated Successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        $data  = Role::find($id);
        $data->delete();
        return redirect()->Action([RoleController::class,'index'])->with('success','Role has been deleted successfully');
    }
}
